...
export default function TourDetailsPage() {
  ...
  if (!loading && !tour) return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#022c22] text-white font-montserrat">
      ...
      <button onClick={() => window.history.back()} className="mt-8 px-8 py-3 border border-[#D9A441] text-[#D9A441] rounded-full hover:bg-[#D9A441] hover:text-black transition duration-300">Return Home</button>
    </div>
  );
