...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0f172a] px-4 py-12 font-sans relative overflow-hidden">
      <SEO title="Login - HillWay" description="Login to your HillWay account." />
          ...
          <div className="p-6 md:p-8">
            ...
            <div className="grid grid-cols-2 gap-2 p-1 bg-black/20 rounded-2xl mb-8 relative">
              ...
              <button
                ...
                className={`flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-bold transition-all duration-300 ${role === 'agent'
              ...
              <button
                ...
                className={`flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-bold transition-all duration-300 ${role === 'admin'
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <button
                disabled={loading}
                className={`w-full py-4 rounded-2xl font-bold text-white shadow-xl transition-all active:scale-[0.98] flex items-center justify-center gap-3 text-lg ${role === 'admin'
