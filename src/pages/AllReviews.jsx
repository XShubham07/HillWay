...
export default function AllReviews() {
    ...
    return (
        <div className="min-h-screen text-white pt-28 pb-20 px-4 sm:px-6 font-inter">
            <SEO title="Traveler Reviews - HillWay" description="See what our travelers say about their experiences with HillWay." />
