...
// Fallback endpoint if not in env
const urlEndpoint = import.meta.env.VITE_IMAGEKIT_URL_ENDPOINT || "https://ik.imagekit.io/hillway";
...
export default function TourCard({ tour }) {
  ...
  // Build the URL using slug, fallback to _id or id
  const tourUrl = `/tours/${tour.slug || tour._id || tour.id}`;

  return (
    <Link to={tourUrl} className="block">
      <motion.div
        whileHover={{ y: -6 }}
